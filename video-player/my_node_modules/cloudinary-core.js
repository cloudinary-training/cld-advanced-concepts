/**
   * cloudinary-main.js
   * Cloudinary's JavaScript library - Version 2.8.2
...
var URL_KEYS = ['api_secret', 'auth_token', 'cdn_subdomain', 'cloud_name', 'cname', 'format', 'private_cdn', 'resource_type', 'secure', 'secure_cdn_subdomain', 'secure_distribution', 'shorten', 'sign_url', 'signature', 'ssl_detected', 'type', 'url_suffix', 'use_root_path', 'version'];
/**
...
function textlayer_createSuper(Derived) { return function () { var Super = textlayer_getPrototypeOf(Derived), result; if (textlayer_isNativeReflectConstruct()) { var NewTarget = textlayer_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return textlayer_possibleConstructorReturn(this, result); }; }
...
function subtitleslayer_createSuper(Derived) { return function () { var Super = subtitleslayer_getPrototypeOf(Derived), result; if (subtitleslayer_isNativeReflectConstruct()) { var NewTarget = subtitleslayer_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return subtitleslayer_possibleConstructorReturn(this, result); }; }
...
function fetchlayer_createSuper(Derived) { return function () { var Super = fetchlayer_getPrototypeOf(Derived), result; if (fetchlayer_isNativeReflectConstruct()) { var NewTarget = fetchlayer_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return fetchlayer_possibleConstructorReturn(this, result); }; }
...
function parameters_createSuper(Derived) { return function () { var Super = parameters_getPrototypeOf(Derived), result; if (parameters_isNativeReflectConstruct()) { var NewTarget = parameters_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return parameters_possibleConstructorReturn(this, result); }; }
...
function imagetag_createSuper(Derived) { return function () { var Super = imagetag_getPrototypeOf(Derived), result; if (imagetag_isNativeReflectConstruct()) { var NewTarget = imagetag_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return imagetag_possibleConstructorReturn(this, result); }; }
...
function sourcetag_createSuper(Derived) { return function () { var Super = sourcetag_getPrototypeOf(Derived), result; if (sourcetag_isNativeReflectConstruct()) { var NewTarget = sourcetag_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return sourcetag_possibleConstructorReturn(this, result); }; }
...
function picturetag_createSuper(Derived) { return function () { var Super = picturetag_getPrototypeOf(Derived), result; if (picturetag_isNativeReflectConstruct()) { var NewTarget = picturetag_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return picturetag_possibleConstructorReturn(this, result); }; }
...
function videotag_createSuper(Derived) { return function () { var Super = videotag_getPrototypeOf(Derived), result; if (videotag_isNativeReflectConstruct()) { var NewTarget = videotag_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return videotag_possibleConstructorReturn(this, result); }; }
...
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || normalizeToArray_unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return normalizeToArray_arrayLikeToArray(arr); }
